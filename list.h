...
// =================================================================
template <class T>
T List<T>::get(uint index) const {   //Complejidad Algoritmica O(n)
	T aux;
	Node<T> *p;
...
// =================================================================
template <class T>
void List<T>::insert_at(T val, uint index) { //Complejidad Algoritmica O(n). El peor de los casos seria insertar al final
	Node<T> *q, *p;
...
// =================================================================
template <class T>
T List<T>::remove_at(uint index) { // Complejidad Algoritmica O(n). Peor de los casos es eliminar el ultimo valor.
	T aux;
	Node<T> *p,*q;
...
// =================================================================
template <class T>
long int List<T>::indexOf(T val) const {  //Complejidad Algoritmica O(n). Peor de los casos es ir hasta la ultima posicion
	Node<T> *p;
	int index = 0;
